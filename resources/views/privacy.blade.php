        ...
        <header class="major">
				...
				<div class="container">
					<div class="row">
						<div class="12u">
							<section>
								<h2>¿QUÉ HACEMOS CON TU INFORMACIÓN?</h2>
                                <p>Cuando navegas en nuestra página, recibimos de manera automática la dirección de protocolo de internet de tu computadora (IP) con el fin de proporcionarnos información que nos ayuda a conocer acerca de su navegador y sistema operativo.</p>
								<h2>CONSENTIMIENTO</h2>	
								<p>Cuando nos provees tu información personal para completar una transacción, implicamos que aceptas la recolección y uso por esa razón específica solamente. Si te pedimos tu información personal por una razón secundaria, como marketing, te pediremos directamente tu expreso consentimiento, o te daremos la oportunidad de negarte.</p>
								<p>¿Cómo puedo anular mi consentimiento?</p>
								<p>Si luego de haber aceptado cambias de opinión, puedes anular tu consentimiento para que te contactemos, por la recolección, uso o divulgación de tu información, en cualquier momento, contactándonos a <b>proveedorareysi@hotmail.com.</b></p>
								<h2>DIVULGACIÓN</h2>
								<p>Podremos divulgar tu información personal si se nos requiere por ley o si violas nuestros Términos de Servicio.</p>
								<h2>SERVICIOS DE TERCERAS PARTES</h2>
								...
								<p>Una vez que abandonas el sitio web o te re-diriges a un sitio o aplicación de terceros, ya no estás siendo regulado por la presente Política de Privacidad o los Términos de Servicio de nuestra página web.</p>
								<h2>ENLACES</h2>
								...
								<p>Al utilizar este sitio, declaras que tienes al menos la mayoría de edad en tu estado o provincia de residencia y que nos has dado tu consentimiento para permitir que cualquiera de tus dependientes menores use este sitio.</p>
								<h2>CAMBIOS A ESTA POLÍTICA DE PRIVACIDAD</h2>
								<p>Nos reservamos el derecho de modificar esta política de privacidad en cualquier momento, así que por favor revísala frecuentemente. Cambios y aclaraciones entrarán en vigencia inmediatamente después de su publicación en el sitio web. Si hacemos cambios materiales a esta política, notificaremos por este mismo medio que ha sido actualizada, por lo cual estás enterado de qué información recopilamos, cómo y bajo qué circunstancias, si las hubiere, la utilizamos y/o divulgamos.</p>
								<p>Si nuestra empresa es adquirida o fusionada con otra, tu información puede ser transferida a los nuevos propietarios.</p>
								<h2>PREGUNTAS E INFORMACIÓN DE CONTACTO</h2>
								<p>Si deseas acceder, corregir, enmendar o borrar cualquier información personal que poseamos sobre ti, registrar una queja, o simplemente quieres más información contáctanos en <b>proveedorareysi@hotmail.com.</b></p>
							</section>
                        </div>
					</div>
				</div>
